...
Maran anlatmaya nereden başlayacağını bilemedi.

"Bir sistemin insanı korumak için onu insandan çıkarabileceğini," dedi sonunda. "Özgür bırakmak için de yalnızlaştırabileceğini."

"Mesajın kaynağını buldun mu?"

"Hayır."

Elena'nın yüzünde hayal kırıklığı değil, rahatlama vardı.

"Belki de iyi oldu. Kesin cevaplar çok hızlı kurumlaşır."

Alfa Bir ağı sonraki aylarda büyüdü. İnsanlar yalnız mesajın kaynağını araştırmak için değil, kendi alanlarındaki sorunları insan merkezli biçimde dönüştürmek için bir araya geldi. Her çalışma gerçek bir ihtiyaçla başlıyor; farklı bilgi alanlarıyla inceleniyor; açık bir model, ölçülebilir deney ve kullanılabilir sonuç üretmeye çalışıyordu. Teknoloji, insanın yerine geçmek için değil; yargısını, yaratıcılığını, güvenliğini, onurunu ve eyleyebilme gücünü desteklemek için kullanılıyordu.
...
Maran ilk kayıt dosyasını açtı.

KAYIT 0001

Tarih: 29.07.2026

Durum: İnsan merkezli hesaplama ağı etkin.

İlke: Yerelde geliştir. Evrensel tasarla. Açık yayımla. İnsanca dönüştür.

Dosyanın altında kendisinin eklemediği bir bağlantı vardı:

https://github.com/human-centered-computing/human-centered-universe

Depoda okurlar için ikinci bir kapı da vardı:

https://human-centered-computing.github.io/human-centered-universe/

Sayfanın üstünde üç sözcük duruyordu: OKU / KEŞFET / OLUŞTUR. Okur bir hikâyeyi yalnız sırayla takip etmek zorunda değildi; bağlantıların izini sürebiliyor, başka bir dil seçebiliyor, Dünya Tohumunu tarayıcısında saklayabiliyor ve isterse GitHub üzerinden yeni bir dal açarak evrenin üretimine katılabiliyordu.
...
"Birinci okur bağlandı. Dünya Tohumu alındı."

Ardından rüyadaki boşluk açıldı:

RİHÊ ______

"Riha neyin ruhu?"

Maran kameraya baktı. Ekranın karanlık yüzeyinde kendi yansımasını görmeyi bekliyordu.

Bu kez orada siz vardınız.
...
Kayıt X'teki "biyolojik kuantum merkez" ifadesi de karakterin hipotezidir; insan beyninin kuantum bilgisayar olduğu yerleşik bilim tarafından gösterilmiş değildir. Beyindeki atomlar kuantum yasalarına uysa da bundan düşüncenin kübitlerle işlendiği, bilincin kuantum üstünlüğü sağladığı veya beynin tek başına yeni bir fiziksel evren yaratabileceği sonucu çıkmaz. Romanda beyin; kanıtlanmış bir kuantum işlemci olarak değil, çelişki, hafıza, duygu ve değerleri aynı ilişkide taşıyan biyolojik merkez olarak kullanılır. Kuantum alanla birleşmesi ve bilinmeyen ışıkla kendiliğinden etkinleşmesi bilimkurgu gizemidir.

Rih Köprüsü de bugünün teknolojisi olarak sunulmaz. Günümüzde yaşayan insanların sinirsel etkinliğinden sınırlı hareket veya konuşma niyetleri çözülebilmekte ve yapay zekâ bu sinyallerin metne çevrilmesine yardım edebilmektedir. Ölüm sonrası hayvan çalışmalarında bazı hücresel ve dolaşımsal işlevlerin belirli koşullarda kısmen geri getirilebildiği gösterilmiştir; fakat bu çalışmalar bilinçli bir kişiyi geri getirmemiş, kişisel hafızayı konuşturmamış ve ölümden sonra süren bir benlik kanıtlamamıştır. Uzun süre korunmuş bir insan beyninin bilgisayarla konuşması, çocuklarına kişisel rehberlik yapması ve aynı kişi olarak devam etmesi bu kitabın bilimkurgu katmanıdır.

Bu nedenle anlatıda biyolojik doku, kişisel arşiv ve yapay zekâ çıkarımı ayrı gösterilir. Bir sesin sevdiğimiz kişiye benzemesi, o kişinin geri döndüğünü tek başına kanıtlamaz. Bölümün asıl meselesi ölümsüzlük değil; kimlik, rıza, yas, çocukların özerkliği ve ölmüş bir insanın etkisinin nerede sona ermesi gerektiğidir.
...
Hangisinin hangisi olduğu özellikle bölüm içinde açıklanmadı. Çünkü bu kitabın temel sorusu yalnız "Bu gerçek mi?" değildir.

Asıl soru şudur:

"Gerçek olmasını istediğimiz gelecek için bugün hangi yapıyı kuruyoruz?"

Yaratılış tamamlanmadı. Okur bağlandığında yeniden başlar.
